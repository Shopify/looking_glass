...
class LookingGlassTest < MiniTest::Test
  def test_modules
  ...
  def test_instances_of
    ...
    inst1 = klass1.new
    inst2 = klass2.new
    instances = LookingGlass.instances_of(klass1).map(&:name)
  ...
  def test_object_by_id
    o = Object.new
    assert_equal(o.inspect, LookingGlass.object_by_id(o.object_id).name)
  end
